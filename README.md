...
|-----------|------------------------------------------------------------------------------------------------------------------------------------|-----------|------------|
| `main`    | Default branch, ported from [`gunrock/essentials`](https://github.com/gunrock/essentials) , serves as the official release branch. | ≥ `2.x.x` | Active     |
| `develop` | Development feature branch, ported from [`gunrock/essentials`](https://github.com/gunrock/essentials).                             | ≥ `2.x.x` | Active     |
| `master`  | Previous release branch for `gunrock/gunrock` version `1.x.x` interface, preserves all commit history.                             | ≤ `1.x.x` | Deprecated |
| `dev`     | Previous development branch for `gunrock/gunrock`. All changes now merged in `master`.                                             | ≤ `1.x.x` | Deprecated |
