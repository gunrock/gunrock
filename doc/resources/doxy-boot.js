// https://raw.githubusercontent.com/Velron/doxygen-bootstrapped/master/doxy-boot.js
$( document ).ready(function() {
    ...
    $('li > a[href="pages.html"] > span').before("<i class='fa fa-tags'></i> ");
    $('li > a[href="files.html"] > span').before("<i class='fa fa-file-code-o'></i> ");
    $('li > a[href="globals.html"] > span').before("<i class='fa fa-globe'></i> ");
    $('li > a[href="hierarchy.html"] > span').before("<i class='fa fa-sort-amount-asc'></i> ");
