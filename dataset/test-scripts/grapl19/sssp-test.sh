...
SETTING[0]=" --src=0 --iteration-num=10 --queue-sizing=1 --in-sizing=1 --traversal-mode=LB --quick"
SETTING[1]=" --src=largestdegree --iteration-num=10 --queue-sizing=1 --in-sizing=1 --traversal-mode=LB --quick"
