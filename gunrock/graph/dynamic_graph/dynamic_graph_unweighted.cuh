...
struct Dyn<_VertexT, _SizeT, _ValueT, _FLAG, cudaHostRegisterFlag, true, false> : DynamicGraphBase<_VertexT, _SizeT, _ValueT, _FLAG> {
...
template<
    ...
    GraphFlag _FLAG,
    unsigned int cudaHostRegisterFlag>
struct Dyn<_VertexT, _SizeT, _ValueT, _FLAG, cudaHostRegisterFlag, false, false> : DynamicGraphBase<_VertexT, _SizeT, _ValueT, _FLAG> {
