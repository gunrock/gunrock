...
class graph_base_t {
 ...
 public:
  ...
  __host__ __device__ __forceinline__ virtual edge_type
  get_neighbor_list_length(vertex_type const& v) const = 0;
  ...
  // __host__ __device__ __forceinline__
  // virtual vertex_pair_type get_source_and_destination_vertices(edge_type
  // const& e) const = 0; // XXX: return type?

  // __host__ __device__ __forceinline__
  // virtual edge_type get_edge(vertex_type const& source, vertex_type const&
  // destination) const = 0;
