    ...
    <EnactorT, Use_FullQ | Push>
{
    ...
    cudaError_t Core(int peer_ = 0)
    {
        ...
        */
        ...
        cpu_timer.Start();
        GUARD_CU(graph.edge_values.Move(util::DEVICE, util::HOST, 
            graph.edges, 0, oprtr_parameters.stream));
        ...
        GUARD_CU(vertex_reachabilities.ForAll(
            [edge_residuals, graph, community_sizes, source]
            __host__ __device__ (bool *vertex_reachabilities, const SizeT &idx){
        ...
        ////////////////////////////////
        GUARD_CU(community_weights.ForAll(
        [community_sizes, next_communities, num_comms, vertex_reachabilities, community_accus] 
        ...
        GUARD_CU(community_accus.ForAll([active, community_accus, curr_communities]
            __host__ __device__ (ValueT *community_accus, SizeT &v){
            {
                if(active[0] == 0){
        ...
        GUARD_CU(community_accus.ForAll([active, community_accus, curr_communities, Y]
            __host__ __device__ (ValueT *community_accus, SizeT &v){
            {
                if(active[0] == 0){
