    ...
    //false >               // _KEEP_NODE_NUM
{
    ...
    */
    struct DataSlice : BaseDataSlice
    {
        ...
        util::Array1D<SizeT, SizeT> mst_output;  // mask indicates selected MST edges
        ...
        int           partition_seed   = -1)
    {
        ...
        do
        {
            if (num_gpus <= 1)
            {
                ...
                //  return ret;
                if (ret = data_slices[gpu]->done_flags.Init(1, util::HOST | util::DEVICE, true,
                    cudaHostAllocMapped | cudaHostAllocPortable)) return ret;
