    ...
    <EnactorT, Use_FullQ | Push>
{
     ...
     * @tparam NUM_VERTEX_ASSOCIATES Number of data atcociated with each transmition item, typed VertexT
     * @tparam NUM_VALUE__ASSOCIATES Number of data atcociated with each transmition item, typed ValueT
    ...
    cudaError_t ExpandIncoming(SizeT &received_length, int peer_)
    {
        ...
        __host__ __device__(
            ...
            ValueT  *value__atcociate_ins) -> bool
        {
            return true;
        };
