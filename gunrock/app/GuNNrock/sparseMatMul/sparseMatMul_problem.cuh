 ...
 *
 * @brief GPU Storage management Structure for sparseMatMul Problem Data
 */
 ...
 * @tparam _LabelT  Type of labels used in sparseMatMul
...
//        data_slice.output.Print();
   ...
   *
   * @param      graph   The graph that sparseMatMul processes on
