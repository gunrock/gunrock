 ...
 * mf_functor.cuh
 *
 * @brief Device functions for MF problem.
 */
...
/**
 * @brief Structure contains device functions in MF graph traverse.
 *
...
struct MFFunctor {
    ...
    /**
     * @brief Vertex mapping apply function. Doing nothing for MF problem.
     *
     * @param[in] v auxiliary value.
     * @param[in] node Vertex identifier.
     * @param[out] d_data_slice Data slice object.
