...
#include <gunrock/util/global_barrier.cuh>
...
class BFSEnactor : public EnactorBase
{
    ...
    /**
     * Machanism for implementing software global barriers from within
     * a single grid invocation
     */
    gunrock::util::GlobalBarrierLifetime         global_barrier;
        ...
        int vertex_map_grid_size)
    {
        ...
        do {
            ...
            //initialize software global barriers
            if (retval = global_barrier.Setup(edge_map_grid_size)) break;
