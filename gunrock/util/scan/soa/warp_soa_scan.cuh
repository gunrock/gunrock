...
struct WarpSoaScan {
  ...
  struct Iterate {
    ...
    static __device__ __forceinline__ Tuple Scan(Tuple partial,
  ...
  struct Iterate<WIDTH, WIDTH> {
    // Scan
    template <typename Tuple, typename WarpscanSoa, typename ReductionOp>
    static __device__ __forceinline__ Tuple Scan(Tuple exclusive_partial,
                                                 WarpscanSoa warpscan_partials,
                                                 ReductionOp scan_op,
                                                 int warpscan_tid) {
  ...
  static __device__ __forceinline__ Tuple Scan(
      ...
      WarpscanSoa warpscan_partials,  // Smem for warpscanning containing at
                                      ...
                                      // (the first being initialized to zero's)
