...
struct RakingGrid
{
    ...
    enum {
        ...
        LOG_SEGS_PER_BANK_ARRAY         = GR_MAX(0, LOG_PARTIALS_PER_BANK_ARRAY - LOG_PARTIALS_PER_SEG),
        ...
        LOG_SEGS_PER_ROW                = (NO_PADDING) ?
                                            ...
                                            GR_MIN(LOG_RAKING_THREADS_PER_LANE, LOG_SEGS_PER_BANK_ARRAY),       // Up to as many segments per lane (all lanes must have same amount of padding to have constant lane stride)
        ...
        LOG_BANK_PADDING_PARTIALS       = GR_MAX(0, GR_LOG_BANK_STRIDE_BYTES(CUDA_ARCH) - Log2<sizeof(T)>::VALUE),
        ...
        LANE_PADDING_PARTIALS           = GR_MAX(0, PARTIALS_PER_BANK_ARRAY - PARTIALS_PER_LANE),
        ...
        LOG_ROWS_PER_LANE               = GR_MAX(0, LOG_RAKING_THREADS_PER_LANE - LOG_SEGS_PER_ROW),
    ...
    typedef typename If<_DEPENDENT_LANES && (LOG_RAKING_THREADS > GR_LOG_WARP_THREADS(CUDA_ARCH)),
