...
template <> struct VectorType<unsigned char, 1> {typedef uchar1    Type;};
template <> struct VectorType<unsigned char, 2> {typedef uchar2    Type;};
template <> struct VectorType<unsigned char, 3> {typedef uchar3    Type;};
template <> struct VectorType<unsigned char, 4> {typedef uchar4    Type;};

template <> struct VectorType<short         , 1> {typedef short1     Type;};
...
template <> struct VectorType<unsigned short, 1> {typedef ushort1    Type;};
template <> struct VectorType<unsigned short, 2> {typedef ushort2    Type;};
template <> struct VectorType<unsigned short, 3> {typedef ushort3    Type;};
template <> struct VectorType<unsigned short, 4> {typedef ushort4    Type;};

template <> struct VectorType<int         , 1> {typedef int1     Type;};
...
template <> struct VectorType<unsigned int, 1> {typedef uint1    Type;};
template <> struct VectorType<unsigned int, 2> {typedef uint2    Type;};
template <> struct VectorType<unsigned int, 3> {typedef uint3    Type;};
template <> struct VectorType<unsigned int, 4> {typedef uint4    Type;};

template <> struct VectorType<long         , 1> {typedef long1     Type;};
template <> struct VectorType<long         , 2> {typedef long2     Type;};
template <> struct VectorType<long         , 3> {typedef long3     Type;};
template <> struct VectorType<long         , 4> {typedef long4     Type;};
template <> struct VectorType<unsigned long, 1> {typedef ulong1    Type;};
template <> struct VectorType<unsigned long, 2> {typedef ulong2    Type;};
template <> struct VectorType<unsigned long, 3> {typedef ulong3    Type;};
template <> struct VectorType<unsigned long, 4> {typedef ulong4    Type;};

template <> struct VectorType<long long         , 1> {typedef longlong1     Type;};
...
template <> struct VectorType<unsigned long long, 1> {typedef ulonglong1    Type;};
template <> struct VectorType<unsigned long long, 2> {typedef ulonglong2    Type;};
template <> struct VectorType<unsigned long long, 3> {typedef ulonglong3    Type;};
template <> struct VectorType<unsigned long long, 4> {typedef ulonglong4    Type;};

template <> struct VectorType<float         , 1> {typedef float1     Type;};
...
template <> struct VectorType<double         , 1> {typedef double1     Type;};
