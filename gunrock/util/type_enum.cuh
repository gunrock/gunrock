...
template <TypeId ID> struct Enum2Type_Base{typedef NullType        Type;};
template <> struct Enum2Type_Base<0x01>{typedef          char      Type;};
template <> struct Enum2Type_Base<0x02>{typedef unsigned char      Type;};
template <> struct Enum2Type_Base<0x03>{typedef          short     Type;};
template <> struct Enum2Type_Base<0x04>{typedef unsigned short     Type;};
template <> struct Enum2Type_Base<0x05>{typedef          int       Type;};
template <> struct Enum2Type_Base<0x06>{typedef unsigned int       Type;};
template <> struct Enum2Type_Base<0x07>{typedef          long      Type;};
template <> struct Enum2Type_Base<0x08>{typedef unsigned long      Type;};
template <> struct Enum2Type_Base<0x09>{typedef          long long Type;};
template <> struct Enum2Type_Base<0x0A>{typedef unsigned long long Type;};

template <> struct Enum2Type_Base<0x12>{typedef          float     Type;};
template <> struct Enum2Type_Base<0x14>{typedef          double    Type;};

template <> struct Enum2Type_Base<0x22>{typedef std::string        Type;};
template <> struct Enum2Type_Base<0x24>{typedef char*              Type;};
...
struct Enum2Type
{
    ...
    typedef If < (ID <= 0xFF), BaseType,
        typename VectorType<BaseType, (ID >> 8) + 1>::Type> Type;
};
