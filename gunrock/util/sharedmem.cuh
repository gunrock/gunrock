...
// -------------------------------------------------------------
//
// Modification: added support for more data type needed by
// Gunrock, 2016-01-04
...
struct SharedMemory
{
    ...
    {
        extern __device__ __host__ void Error_UnsupportedType(); // Ensure that we won't compile any un-specialized types
