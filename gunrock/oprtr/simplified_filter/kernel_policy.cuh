...
template <
    ...
    int _MODE>
struct KernelPolicy : public gunrock::oprtr::cull_filter::KernelPolicy <
    _Problem, _CUDA_ARCH, _SATURATION_QUIT, _DEQUEUE_PROBLEM_SIZE,
    _MIN_CTA_OCCUPANCY, _LOG_THREADS, _LOG_LOAD_VEC_SIZE, _LOG_LOADS_PER_TILE,
    _LOG_RAKING_THREADS, _END_BITMASK_CULL, _LOG_SCHEDULE_GRANULARITY, _MODE>
{
    enum{
        MODE = _MODE,
    };
