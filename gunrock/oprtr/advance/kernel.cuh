...
struct LaunchKernel_<Parameter, gunrock::oprtr::advance::LB_CULL>
{
    ...
    static cudaError_t Launch(Parameter *parameter)
    {
        ...
        if (//parameter -> frontier_attribute -> output_length[0] < LBPOLICY::LIGHT_EDGE_THRESHOLD)//)
        ...
        else //if (parameter -> frontier_attribute -> //output_length[0] >= LBPOLICY::LIGHT_EDGE_THRESHOLD)
        {
