...
inline double Sprng(Engine *engine, Distribution *distribution) {
...
inline bool Flip(Engine *engine, Distribution *distribution) {
...
inline void ChoosePartition(VertexId *u, VertexId *v, VertexId step, double a,
                            double b, double c, double d, Engine *engine,
 ...
 * @param[in] rand_data
 */
inline void VaryParams(double *a, double *b, double *c, double *d,
...
int BuildRmatGraph(SizeT nodes, SizeT edges, Csr<VertexId, SizeT, Value> &graph,
                   bool undirected, double a0 = 0.55, double b0 = 0.2,
                   double c0 = 0.2, double d0 = 0.05, double vmultipiler = 1.00,
                   double vmin = 1.00, int seed = -1, bool quiet = false) {
  ...
  EdgeTupleType *coo =
      (EdgeTupleType *)malloc(sizeof(EdgeTupleType) * SizeT(directed_edges));
