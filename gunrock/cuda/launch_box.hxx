...
template<
  ...
  unsigned int smem_bytes_ = 0
>
struct sm_launch_params_t : launch_params_t<block_dimensions_, grid_dimensions_, smem_bytes_> {
...
template<                                 \
  ...
  unsigned int smem_bytes_ = 0            \
>                                         \
using sm##combined = sm_launch_params_t<  \
                       combined,          \
                       block_dimensions_, \
                       grid_dimensions_,  \
                       smem_bytes_        \
