...
struct main_struct {
  ...
  operator()(util::Parameters &parameters, VertexT v, SizeT s, ValueT val) {
    ...
    if (!quick) {
      ...
      float elapsed =
          app::proj::CPU_Reference(graph.csr(), ref_projections, quiet);
    ...
    GUARD_CU(app::Switch_Parameters(
        ...
        [ref_projections](util::Parameters &parameters, GraphT &graph) {
          return app::proj::RunTests(parameters, graph, ref_projections,
                                     util::DEVICE);
        }));

    if (!quick) {
      delete[] ref_projections;
      ref_projections = NULL;
    }
    return retval;
  }
};
...
int main(int argc, char **argv) {
  ...
  return app::Switch_Types<app::VERTEXT_U32B | app::VERTEXT_U64B |
                           ...
                           app::VALUET_F32B | app::DIRECTED>(parameters,
                                                             main_struct());
}
