...
#include <gunrock/app/dump/dump_app.cu>
#include <gunrock/app/test_base.cuh>

using namespace gunrock;

namespace APP_NAMESPACE = app::dump;
...
struct main_struct
{
        ...
        VertexT v, SizeT s, ValueT val)
    {
        ...
        if (!quick) {
            ...
            float elapsed = app::dump::CPU_Reference(
                graph.csr(),
                ref_degrees,
                quiet);
        ...
        GUARD_CU(app::Switch_Parameters(parameters, graph, switches,
            ...
            ](util::Parameters &parameters, GraphT &graph)
            {
                ...
                return app::dump::RunTests(parameters, graph, ref_degrees, util::DEVICE);
                // </TODO>
            }));
...
{
    cudaError_t retval = cudaSuccess;
    util::Parameters parameters("test dump");
    GUARD_CU(graphio::UseParameters(parameters));
    GUARD_CU(app::dump::UseParameters(parameters));
