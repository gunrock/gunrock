# random walk: undirected, uniform
...
APP_OPTIONS="--walk-mode ${WALK_MODE} --walk-length 128 --undirected=true --store-walks 0 --quick --num-runs 10 --seed 123"

OUTPUT_DIR="eval_mgpu/$PARTITION_NAME/$NODE_NAME/undirected-uniform"
mkdir -p $OUTPUT_DIR
