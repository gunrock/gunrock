...
int main(int argc, char* argv[]) {
  ...
  search_tokens[0] = "Label";
  search_tokens[1] = "Validity";
  ...
  search_tokens[0] = "Component";
  search_tokens[1] = "Count";
  items[12].Init("#CC", 2, search_tokens, 2, 1);
  search_tokens[0] = "elements";
  search_tokens[1] = "processed";
  items[13].Init("#elements processed", 2, search_tokens, 2, 1);
  search_tokens[0] = "redundant";
  search_tokens[1] = "work";
