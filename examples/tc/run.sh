...
do
    echo $exe_file market ../../dataset/large/$i/$i.mtx"> ./eval/$SUFFIX/${NAME[$i]}.$SUFFIX${MARKS}.txt"
         $exe_file market ../../dataset/large/$i/$i.mtx > ./eval/$SUFFIX/${NAME[$i]}.$SUFFIX${MARKS}.txt
    sleep 1
done
