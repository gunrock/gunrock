...
int main(int argc, char* argv[])
{
    ...
    search_tokens[0] = "CPU"     ; search_tokens[1] = "CC"; search_tokens[2] = " ";
    items[ 4].Init("CPU depth", 3, search_tokens,  9, 1);
    items[ 5].Init("CPU time" , 2, search_tokens,  4, 1);
    search_tokens[0] = "GPU"     ; search_tokens[1] = "Connected"; search_tokens[2] = " ";
    items[ 6].Init("GPU depth", 3, search_tokens, 10, 1);
    items[ 7].Init("GPU time" , 2, search_tokens,  5, 1);
    search_tokens[0] = "Rate";
    items[ 8].Init("GPU rate" , 1, search_tokens,  1, 1);
    ...
    search_tokens[0] = "-------------------------";
    items[11].Init("Sizematch",1, search_tokens,  1, 1);
    search_tokens[0] = "Component"   ; search_tokens[1] = "Count";
    items[12].Init("#CC"      ,2, search_tokens,  2, 1);
    search_tokens[0] = "elements"   ; search_tokens[1] = "processed";
    items[13].Init("#elements processed"  , 2, search_tokens,  2, 1);
    ...
    search_tokens[0] = "key_sizing";
    items[23].Init("q-sizing" , 1, search_tokens,  2, 1);
    search_tokens[0] = "in_sizing"   ;
    items[24].Init("in-sizing", 1, search_tokens,  2, 1);
    search_tokens[0] = "partition"   ; search_tokens[1] = "end.";
    items[25].Init("partition time", 1, search_tokens,  2, 1);
