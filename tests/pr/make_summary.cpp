...
int main(int argc, char* argv[])
{
    ...
    search_tokens[0] = "CPU"     ; search_tokens[1] = "PR"; search_tokens[2] = " ";
    items[ 4].Init("CPU depth", 3, search_tokens,  9, 1);
    items[ 5].Init("CPU time" , 2, search_tokens,  4, 1);
    search_tokens[0] = "GPU"     ; search_tokens[1] = "PageRank"; search_tokens[2] = " ";
    ...
    search_tokens[0] = "10"   ; search_tokens[1] = "Page";
