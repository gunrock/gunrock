...
do
    echo ./bin/test_bc_5.5_x86_64 market ../../dataset/large/$i/$i.mtx --src=-1
         optirun ./bin/test_bc_5.5_x86_64 market ../../dataset/large/$i/$i.mtx --src=-1 > eval/$SUFFIX/$i.$SUFFIX.txt
    sleep 10
done
...
do
    echo ./bin/test_bc_5.5_x86_64 market ../../dataset/small/$i.mtx --src=-1
         optirun ./bin/test_bc_5.5_x86_64 market ../../dataset/small/$i.mtx --src=-1 > eval/$SUFFIX/$i.$SUFFIX.txt
    sleep 10
done
