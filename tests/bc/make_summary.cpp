...
int main(int argc, char* argv[])
{
    ...
    search_tokens[0] = "CPU"     ; search_tokens[1] = "BC";
    items[ 4].Init("CPU depth", 2, search_tokens,  9, 1);
    items[ 5].Init("CPU time" , 2, search_tokens,  4, 1);
    search_tokens[0] = "GPU"     ; search_tokens[1] = "BC"; search_tokens[2] = " ";
    ...
    search_tokens[0] = "Validity"   ; search_tokens[1] = "labels";
    items[ 9].Init("Label v"  , 2, search_tokens,  2, 1);
    search_tokens[0] = "oversize";
    items[10].Init("Oversize" , 1, search_tokens,  0, 0);
    search_tokens[0] = "Validity"; search_tokens[1] = "BC";
    items[11].Init("BC v"      ,2, search_tokens,  3, 1);
    search_tokens[0] = "edges"   ; search_tokens[1] = "visited";
    items[12].Init("#e visited",2, search_tokens,  2, 1);
    search_tokens[0] = "Validity"   ; search_tokens[1] = "Sigma";
    items[13].Init("Sigma v"  , 2, search_tokens,  2, 1);
